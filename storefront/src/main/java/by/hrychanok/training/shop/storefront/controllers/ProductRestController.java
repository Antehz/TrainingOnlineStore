...
import by.hrychanok.training.shop.storefront.validator.FileInfo;
...
public class ProductRestController {
    ...
    @RequestMapping(
                    value = "/product/{id}", method = RequestMethod.GET,
    ...
    public ResponseEntity<Void> createProduct(
        ...
        headers.setLocation(ucBuilder.path("/product/{id}").buildAndExpand(product.getId())
            .toUri());
    ...
    // ---------------------------File uploading --------------------------------
    @RequestMapping(
                    value = "/fileupload", headers = ("content-type=multipart/*"),
        ...
        if (!inputFile.isEmpty()) {
            try {
                ...
                File destinationFile =
                    new File(context.getRealPath("/WEB-INF/uploaded")
                             + File.separator
                             + originalFilename);
